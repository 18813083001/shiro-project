...
package com.thorough.library.mybatis.persistence.interceptor;

import com.thorough.library.mybatis.persistence.dialect.Dialect;
...
public class SQLHelper {
    ...
    public static int getCount(final String sql, final Connection connection,
        ...
        try {
			...
			if (ReflectionsUtil.getFieldValue(boundSql, "metaParameters") != null) {
				MetaObject mo = (MetaObject) ReflectionsUtil.getFieldValue(boundSql, "metaParameters");
				ReflectionsUtil.setFieldValue(countBS, "metaParameters", mo);
			}
    ...
    public static String generateOrderSql(String sql, Page<Object> page, Dialect dialect){
