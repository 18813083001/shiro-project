package com.thorough.library.mybatis.persistence;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.thorough.library.utils.CookieUtils;
...
public class Page<T> {
	...
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		...
		// 设置排序参数 在xml文件里设置排序，PaginationInterceptor里屏蔽了统一添加排序
		...
		if (StringUtils.isNotBlank(orderBy)){
			...
			if(StringUtils.isNotBlank(orderName) && StringUtils.isNotBlank(order)){
				this.setOrderBy(orderName +" "+order);
			}
		}
	}
